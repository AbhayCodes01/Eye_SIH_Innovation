...
X__   = dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(X_);
pads__   = dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(pads_);
value   = dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(value_);
mode   = dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(mode_);
ONNXAxis   = dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(ONNXAxis_);
numDimsX   = dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(numDimsX_);
