...
%   Copyright 2024 The MathWorks, Inc.  
    ...
    ONNXShape__ = dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(ONNXShape_);
    allowzero   = coder.const(dr_classifier_efficientnetb0.coder.ops.extractIfDlarray(allowzero_));
